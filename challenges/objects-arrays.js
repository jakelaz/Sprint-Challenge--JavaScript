...
for(let i = 0; i < zooAnimals.length; i++) {
  let mappedObj = {};
  mappedObj.animalName = zooAnimals[i].animal_name;
  mappedObj.scientificName = zooAnimals[i].scientific_name;
  let itemString = `Name: ${mappedObj.animalName}, Scientific: ${mappedObj.scientificName}`;
  displayNames.push(itemString);
  mappedObj = {};
}
